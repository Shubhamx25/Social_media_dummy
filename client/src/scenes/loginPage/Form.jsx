...
const registerSchema = yup.object().shape({
  ...
  occupation: yup.string().required('Mandatory field'),
...
const Form = () => {
  ...
  const [ pageType, setPageType ] = useState('login');  //to toggle login and signup forms
  ...
  const register = async (values, onSubmitProps) => {
    console.log('register func fired')
     ...
     {({
      ...
      return (
        <form onSubmit={handleSubmit}>
          ...
          {/* Buttons to toggle login and register */}
          <Box>
            <Button
              fullWidth
              type="submit"
